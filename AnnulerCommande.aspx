<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AnnulerCommande.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="style1">
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="Button1" runat="server" Text="Annuler" Width="80px" 
