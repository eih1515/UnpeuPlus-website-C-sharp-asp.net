<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="technologie.aspx.cs" Inherits="Default2" %>
...
<asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
    ...
    DataKeyNames="Numlivre" DataSourceID="AccessDataSourcetech" ForeColor="#333333" 
...
<asp:AccessDataSource ID="AccessDataSourcetech" runat="server" 
    ...
    <SelectParameters>
        <asp:Parameter DefaultValue="Technologie" Name="categorie" Type="String" />
    </SelectParameters>
